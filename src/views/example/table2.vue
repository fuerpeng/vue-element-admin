<template>
  <div class="app-container calendar-list-container">
    ...
    <el-table :default-sort = "{prop: 'pageviews', order: 'descending'}"  :key='tableKey' :data="list" v-loading.body="listLoading" border fit highlight-current-row style="width: 100%">

      <el-table-column prop="id" align="center" label="序号" width="100" sortable>
        <template scope="scope">
          <span>{{scope.row.id}}</span>
        </template>
      </el-table-column>

      <el-table-column prop="timestamp" width="180px" align="center" label="时间" sortable>
        <template scope="scope">
          <span>{{scope.row.timestamp | parseTime('{y}-{m}-{d} {h}:{i}')}}</span>
        </template>
      </el-table-column>

      <el-table-column min-width="300px" label="标题" sortable>
        <template scope="scope">
      ...
      <el-table-column prop="importance" width="120" label="重要性" sortable>
        <template scope="scope">
